...
urlpatterns = [
    ...
    path('backup/restore_media/<str:filename>/', views.restore_media_backup, name='restore_media_backup'),
    path('backup/restore_media/upload/', views.restore_media_backup_upload, name='restore_media_backup_upload'),
